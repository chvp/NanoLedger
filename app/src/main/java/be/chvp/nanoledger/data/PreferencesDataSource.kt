...
class PreferencesDataSource
    ...
    constructor(
        ...
        val spacingBetweenCurrencyAndAmount: LiveData<Boolean> = sharedPreferences.booleanLiveData(SPACING_BETWEEN_CURRENCY_AND_AMOUNT_KEY, true)

        fun getCurrencyAmountSpacing(): Boolean = sharedPreferences.getBoolean(SPACING_BETWEEN_CURRENCY_AND_AMOUNT_KEY, true)

        fun setCurrencyAmountSpacing(spacing: Boolean) = sharedPreferences.edit { putBoolean(SPACING_BETWEEN_CURRENCY_AND_AMOUNT_KEY, spacing) }
    }
